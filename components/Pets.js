...
const Pets = () => {
  const [petDetails, setPedDetails] = useState(pets[10]);
  ...
  return (
    <section className='bg-pets bg-center py-6 overflow-hidden px-7'>
         ...
         <div className='lg:w-[30%] flex flex-col justify-center items-end pb-6 lg:py-2 mx-auto lg:mx-0'>
            <div className='text-center text-white'>
              ...
              <div className='w-[150px] h-[150px] mx-auto lg:mx-0 border-4 border-white rounded-full'>
                <Image src={petDetails.Image} alt='pet' width={150} height={150}/>
              </div>
            </div>
         </div>
          {/* pet list */}
